...
# JSON-format för spårning av URL:er {#json-formats-for-tracking-urls}

Om klienten begär spårningsinformation i JSON-format skickar manifestservern tillbaka en fil i något av JSON-formaten.

## JSON-format för spårning av version 1 {#json_v1}

JSON-filen som manifestservern skickar om `pttrackingversion=v1` har följande allmänna format:
...
JSON-filen som manifestservern skickar om `pttrackingversion=v3` har följande allmänna format:
