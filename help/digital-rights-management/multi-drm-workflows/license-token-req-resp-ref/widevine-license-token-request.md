...
| Frågeparameter | Beskrivning | Obligatoriskt? |
|--- |--- |--- |
| `expirationTime` | Förfallotid för denna token. Det här värdet MÅSTE vara en sträng i [RFC 339](https://www.ietf.org/rfc/rfc3339.txt) -format för datum/tid i zondesignern&quot;Z&quot; (&quot;Zulu time&quot;) eller ett heltal som föregås av ett +-tecken. Ett exempel på ett RFC 3339-datum/tid är 2006-04-14T12:01:10Z. <br> Om värdet är en sträng i [RFC 339](https://www.ietf.org/rfc/rfc3339.txt) -format för datum/tid representerar det ett absolut förfallodatum/tid för token. Om värdet är ett heltal som föregås av tecknet + tolkas det som ett relativt antal sekunder, från utgivningen, att token är giltig. Anger till exempel `+60` en minut. <br> Maximal token- och standardtokenlivstid (om inget anges) är 30 dagar. | Nej |
...
<table id="table_agj_gqx_pv">  
 ...
 <tbody> 
  ...
  <tr> 
   <td> -4018 </td> 
   <td> Saknat <span class="filepath"> barn </span> </td> 
  </tr> 
  <tr> 
   <td> -4019 </td> 
