...
<table frame="all" colsep="1" rowsep="1" class="+ topic/table adobe-d/table " id="table_q5h_cpy_n4">  
 ...
 <tbody class="- topic/tbody "> 
  ...
  <tr rowsep="1" class="- topic/row "> 
   ...
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">Fråga inte om målfilen ska skrivas över. Om målfilen finns och <span class="codeph"> -o inte </span> är inställd inträffar ett fel. </p> </td> 
  </tr> 
  <tr rowsep="1" class="- topic/row "> 
  ...
  <tr rowsep="1" class="- topic/row "> 
   ...
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">Datumet innan licenserna börjar gälla. </p> <p>Du kan ange datumet i <span class="+ topic/ph pr-d/codeph codeph"> formatet åååå-mm-dd </span> eller <span class="+ topic/ph pr-d/codeph codeph"> åååå-mm-dd-h24:min:sec </span> . Exempel: 2008-12-1 eller 2008-12-1-00:00:00 för midnatt den 1 december 2008. </p> <p> 
     <ul id="ul_D5DB5044756D4BD6A734813971598425"> 
      ...
      <li id="li_3790E2F829A149979BF44E0914CFF431">Om du vill ta bort slutdatumet när du uppdaterar en DRM-princip använder du <span class="codeph"> -e </span> utan att ange ett datum. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr rowsep="1" class="- topic/row "> 
  ...
  <tr rowsep="1" class="- topic/row "> 
   ...
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">Det datum då licenserna blir giltiga. </p> <p>Du kan ange datumet i <span class="+ topic/ph pr-d/codeph codeph"> formatet </span> åååå-mm-dd <span class="+ topic/ph pr-d/codeph codeph"> eller </span> åååå-mm-dd-h24:min:sek. Exempel: <span class="codeph"> 2008-12-1 </span> eller <span class="codeph"> 2008-12-1-00:00:00 </span> för midnatt den 1 december 2008. </p> <p> 
  ...
  <tr rowsep="1" class="- topic/row "> 
   <td colname="1" class="- topic/entry "> <span class="+ topic/ph pr-d/codeph codeph"> -w [&lt;minuter&gt;[,enableHS|disableHS]] </span> </td> 
  ...
  <tr rowsep="1" class="- topic/row "> 
   ...
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">Licensens slutdatum för cachelagring. </p> <p class="- topic/p ">Detta anger det sista datumet då klienten kan cachelagra licenser i klientens licensarkiv efter att Primetime DRM-servern har utfärdat licensen. </p> <p>Du kan ange datumet i följande format: 
     ...
     </ul>Exempel: <span class="codeph"> 2008-12-1 </span> eller <span class="codeph"> 2008-12-1-00:00:00 </span> för midnatt den 1 december 2008. Du måste tillämpa <span class="codeph"> -l </span> utan att ange några minuter för obegränsad licenscache. </p> </td> 
  </tr> 
  <tr rowsep="1" class="- topic/row "> 
