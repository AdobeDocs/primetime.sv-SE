...
Implementera IAAConfig om du vill välja ljudspår för det [senast bindande ljudet](https://help.adobe.com/en_US/primetime/api/reference_implementation/android/javadoc/com/adobe/primetime/reference/config/IAAConfig.html).
