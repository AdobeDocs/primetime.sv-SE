...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><p> <strong>TimedMetadata</strong>: interface TimedMetadata {<br /> const unsigned short METADATA_TYPE_TAG = 0 ; <br /> const unsigned short METADATA_TYPE_ID3 = 1 ; skrivskyddat <br /> attribut utan signerad kort typ, Lång <br /> skrivskyddad attributtid.<br /> skrivskyddat attribut DomString id;<br /> skrivskyddat attribut DOMString-namn;<br /> skrivskyddat attribut DOMString-innehåll; metadata för <br /> skrivskyddat attributobjekt,<br /> }; </p> </td> 
   <td><p>interface TimedMetadata {<br /> const unsigned short METADATA_TYPE_TAG = 0 ;<br /> const unsigned short METADATA_TYPE_ID3 = 1 ;<br /> skrivskyddat attribut unsigned short metadataType;<br /> skrivskyddat attribut, lång tid,<br /> long id för skrivskyddat attribut,<br /> skrivskyddat attribut DOMString-namn;<br /> metadata för <br /> skrivskyddat attributobjekt,<br /> };</p> </td> 
  </tr> 
  <tr> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><p>Interface AdvertisingMetadata { <br /> attribute AdSignalingMode; <br /> attribute AdBreakWatchedPolicy adBreakAsWatched; <br /> attribute boolean livePreroll; boolesk <br /> fördröjningAdLoading; <br /> };</p> </td> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><p>interface ReplaceTimeRange { <br /> attribute unsigned long begin; skrivskyddat <br /> attribut utan signerad lång ände, <br /> attributet har lång varaktighet utan tecken, <br /> attribut unsigned long replaceDuration; <br /> };</p> </td> 
   <td>(Nytt i 2.0)</td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><p>gränssnittsmöjlighet { <br /> readonly attribute DomString id; Placering av <br /> skrivskyddade attribut. Inställningar för <br /> skrivskyddat attributobjekt. <br /> read-only attribute Object customParameters; <br /> }; </p> </td> 
   <td>(Nytt i 2.0)</td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><p><strong>Tidslinje</strong>: interface Timeline <br /> { readonly attribute TimelineMarkerList timelineMarkers; tidslinjeobjekt för <br /> skrivskyddat attribut: TimelineItemList; <br /> double convertToLocalTime( dubbel tid); <br /> double convertToVirtualTime( dubbel tid); <br /> };</p> </td> 
   <td><p>interface Timeline {<br /> readonly attribute TimelineMarkerList timelineMarkers;<br /> <br /> <br /> <br /> };</p> </td> 
  </tr> 
  <tr> 
   <td><p> <strong>Tidslinjeobjekt</strong>: interface TimelineItem :<br /> TimelineMarker {<br /> readonly attribute long id; skrivskyddat <br /> attribut TimeRange virtualRange; skrivskyddat <br /> attribut TimeRange localRange; boolesk <br /> betraktad skrivskyddad attribut, skrivskyddat <br /> attribut (boolesk temporär), <br /> }; </p> </td> 
   <td>(Nytt i 2.0)</td> 
  </tr> 
  <tr> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><p>interface AdBreak {<br /> <br /><br /> <br /> readonly attribute double duration;<br /> skrivskyddade attribut AdList ads;<br /> <br /> skrivskyddat <br /> attribut AdInsertionType insertionType;<br /> }; </p> </td> 
   <td><p>interface AdBreak {<br /> readonly attribute double time;<br /> skrivskyddat attribut double replaceDuration;<br /> dubbellängd för <br /> skrivskyddat attribut,<br /> skrivskyddat attribut AdList adList;<br /> <br /> skrivskyddade attribut DOMString-data;<br /> <br /> }; </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><p> <strong>Annons</strong>: interface Ad {<br /> readonly attribute AdAsset primaryAsset;<br /> skrivskyddat attribut AdAssetList companionAssets;<br /> dubbellängd för <br /> skrivskyddat attribut,<br /> skrivskyddat attribut DomString id;<br /> const unsigned short ADTYPE_LINEAR = 0 ;<br /> const unsigned short ADTYPE_NONLINEAR = 1 ;<br /> skrivskyddat <br /> attribut osignerat kort adType;<br /> skrivskyddat attribut AdInsertionType adInsertionType; boolesk klickbarhet <br /> <br /> för skrivskyddat attribut, booleskt <br /> skrivskyddat attribut isCustomAdMarker;<br /> }; </p> </td> 
   <td><p>interface Ad {<br /> readonly attribute AdAsset primaryAsset;<br /> skrivskyddat attribut AdAssetList companionAssets;<br /> dubbellängd för <br /> skrivskyddat attribut,<br /> skrivskyddat attribut DomString id;<br /> const unsigned short ADTYPE_LINEAR = 0 ;<br /> const unsigned short ADTYPE_NONLINEAR = 1 ;<br /> skrivskyddat <br /> attribut utan signerad kort typ,<br /> skrivskyddat attribut AdInsertionType insertionType; Object Tracker för <br /> skrivskyddade attribut;<br /> <br /> <br /> }; </p> </td> 
  </tr> 
  <tr> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><p><strong>AdTimelineItem</strong>: interface AdTimelineItem : TimelineItem { <br /> readonly attribute AdBreak adBreak; Ad ad, <br /> skrivskyddat attribut, <br /> }; </p> </td> 
   <td> (Nytt i 2.0)</td> 
  </tr> 
  <tr> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><p> ...<br /> skrivskyddat attribut short AD_POLICY_MODE_PLAY;<br /> skrivskyddat attribut short AD_POLICY_MODE_SEEK;<br /> skrivskyddat attribut short AD_POLICY_MODE_TRICKPLAY;<br /> };</p> </td> 
  </tr> 
  <tr> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><p>interface MediaPlayerItemConfig {<br /> attribute ContentFactory adFactory;<br /> attribute StringList subscribeTags;<br /> <br /> attributet StringList adTags;<br /> <br /> Attributet <br /> AdSignalingMode ochSignalingMode;<br /> customRangeMetadata-attributet CustomRangeMetadata;<br /> attribute NetworkConfiguration networkConfiguration;<br /> attribute AdvertisingMetadata advertisingMetadata;<br /> attribute Boolean useHardwareDecoder;<br /> };</p> </td> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td>Ingen ändring för 2.0.</td> 
   <td><p>gränssnitts-DRMLicense {<br /> skrivskyddat attribut Uint8Array-byte;<br /> skrivskyddat attribut Date licenseStartDate;<br /> skrivskyddat attribut Date licenseEndDate;<br /> skrivskyddat attribut Date offlineStorageStartDate;<br /> skrivskyddat attribut Date offlineStorageEndDate; skrivskyddat <br /> attribut DOMString serverUrl;<br /> skrivskyddat attribut DomString licenseID;<br /> skrivskyddat attribut DomString policyID;<br /> skrivskyddat attribut: DRMPlaybackTimeWindow playbackTimeWindow;<br /> skrivskyddat attribut Object customProperties;<br /> }; </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><p>interface DRMLicenseDomain {<br /> readonly attribute DOMString authenticationDomain;<br /> skrivskyddat attribut DRMAuthenticationMethod authenticationMethod; skrivskyddat <br /> attribut DOMString serverUrl;<br /> };</p> </td> 
   <td><p>interface DRMLicenseDomain {<br /> readonly attribute DOMString authDomain;<br /> skrivskyddat attribut: DRMAuthenticationMethod authMethod; skrivskyddat <br /> attribut DOMString serverURL;<br /> };</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><p>interface DRMPolicy<br /> {<br /> readonly attribute DomString authenticationDomain;<br /> skrivskyddat attribut DRMAuthenticationMethod authenticationMethod;<br /> skrivskyddat attribut DOMString displayName; <br /><br /> skrivskyddat attribut DRMLicenseDomain licenseDomain;<br /> };</p> </td> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td>captionsUppdaterat <br /> När ett mediaspelarobjekt uppdateras. För live/linjär direktuppspelning måste klienten regelbundet uppdatera medieresursen för att kunna identifiera det nya tillgängliga innehållet. När detta inträffar kan vissa mediaegenskaper ändras.</td> 
   <td>MediaPlayerItemEvent</td> 
   <td> </td> 
   <td><p>Nyheter i 2.0</p> </td> 
   <td> </td> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><p>interface MediaPlayerItem {<br /> readonly attribute MediaResource;<br /> skrivskyddat attribut long resourceId;<br /> skrivskyddat attribut boolesk live,<br /> booleskt <br /> skrivskyddat attribut hasAlternateAudio;<br /> skrivskyddat attribut AudioTrackList audioTracks;<br /> skrivskyddat attribut AudioTrack selectedAudioTrack;<br /> void selectAudioTrack(ljudspår); Det <br /> <br /> skrivskyddade attributet boolean hasClosedCaptions.<br /> skrivskyddat attribut ClosedCaptionsTrackList closedCaptionsTracks;<br /> skrivskyddat attribut ClosedCaptionsTrack selectedClosedCaptionsTrack;<br /> void selectClosedCaptionsTrack(<br /> spårningen ClosedCaptionsTrack); boolesk hasTimedMetadata för <br /><br /> skrivskyddat attribut,<br /> skrivskyddat attribut TimedMetadataList timedMetadata;<br /> skrivskyddat attribut booleskt dynamiskt,<br /> booleskt <br /> skrivskyddat attribut isProtected;<br /> skrivskyddat attribut DRMMetadataInfoList drmMetadataInfos;<br /> skrivskyddade attribut ProfileList-profiler;<br /> skrivskyddad attributprofil selectedProfile;<br /> skrivskyddat <br /> attribut boolean trickPlaySupported;<br /> skrivskyddat attribut FloatArray availablePlaybackRates;<br /> skrivskyddat attribut float selectedPlaybackRate;<br /> <br /> skrivskyddat <br /> attribut MediaPlayer mediaPlayer;<br /> skrivskyddat attribut, konfiguration av MediaPlayerItemConfig;<br /> };</p> </td> 
   <td><p>interface MediaPlayerItem {<br /> readonly attribute MediaResource;<br /> skrivskyddat attribut long resourceId;<br /> skrivskyddat attribut boolesk live,<br /> booleskt <br /> skrivskyddat attribut hasAlternateAudio;<br /> skrivskyddat attribut AudioTrackList audioTracks;<br /> attribute AudioTrack selectedAudioTrack;<br /> Det <br /> <br /> skrivskyddade attributet boolean hasClosedCaptions.<br /> skrivskyddat attribut ClosedCaptionsTrackList ccTracks;<br /> attribute ClosedCaptionsTrack selectedCCTrack;<br /> booleskt <br /> skrivskyddat <br /> <br /> attribut hasTimedMetadata;<br /> skrivskyddat attribut TimedMetadataList timedMetadata;<br /> skrivskyddat attribut booleskt dynamiskt,<br /> booleskt <br /> skrivskyddat attribut isProtected;<br /> skrivskyddat attribut DRMMetadataInfoList drmMetadataInfos;<br /> skrivskyddade attribut ProfileList-profiler;<br /> boolesk <br /> trickPlaySupported som <br /> skrivskyddat attribut;<br /> skrivskyddat attribut Int32Array availablePlaybackRates;<br /> det skrivskyddade <br /> attributet StringList adTags;<br /> skrivskyddat <br /> attribut MediaPlayer mediaPlayer;<br /> <br /> };</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>interface AudioTrack<br /> {<br /> readonly attribute DomString name;<br /> skrivskyddat attribut DOMString-språk; boolesk standard för <br /> skrivskyddat attribut,<br /> skrivskyddat attribut boolean autoSelect;<br /> skrivskyddat attribut (booleskt) framtvingat,<br /> <br /> };</p> </td> 
  </tr> 
  <tr> 
   <td>Ingen ändring för 2.0</td> 
  ...
  <tr> 
   ...
   <td><p>interface ClosedCaptionsTrack<br /> {<br /> readonly attribute DomString name;<br /> skrivskyddat attribut DOMString-språk;<br /> boolesk standardinställning för skrivskyddat attribut,<br /> boolesk <br /> <br /> funktion för skrivskyddat attribut.<br /> <br /><br /> <br /> <br /><br /> };</p> </td> 
  </tr> 
  <tr> 
   <td>Ingen ändring för 2.0</td> 
...
ActionScript/JAVA genererar även undantag från konstruktorer för att ange att vissa interna objekt skapades felaktigt. Dessa undantag hanteras internt och sprids inte till programmet. Undantagen inkluderas i ett varningsmeddelande som skickas till programmet
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>-</td> 
   <td>-</td> 
   <td>Undantag med koden = 4, description = "GENERIC_ERROR" och additionalInfo= &lt;som skickas av metoden som utlöste det här undantaget&gt;</td> 
  </tr> 
  <tr> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td>Ingen ändring för 2.0</td> 
   <td><p>gränssnittet QOSProvider<br /> {<br /> void attachMediaPlayer(MediaPlayer player);<br /> void detachMediaPlayer();<br /> skrivskyddat <br /> attribut DeviceInformation deviceInformation;<br /> skrivskyddat attribut PlaybackInformation playbackInformation;<br /> };</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><p>gränssnittet DeviceInformation<br /> {<br /> readonly attribute DomString os;<br /> <br /> Det <br /> <br /> skrivskyddade attributet DomString id.<br /> skrivskyddat attribut int sityDPI;<br /> skrivskyddat attribut int heightPixels;<br /> skrivskyddat attribut int widthPixels;<br /> skrivskyddat attribut booleskt seekToKeyFrame;<br /> };</p> </td> 
