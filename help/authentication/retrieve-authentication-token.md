...
| _deviceType_ | Enhetstypen (t.ex. Roku, PC).</br></br>**Anteckning**: device_info ersätter den här parametern. |
...
| _appId_ | Program-ID/namn. </br></br>**Anteckning**: device_info ersätter den här parametern. Om den används, `appId` ska ha samma värden som i [Skapa registreringskod](http://tve.helpdocsonline.com/registration-code-request) begäran. |
