...
| extra parametrar | Anropet kan även innehålla valfria parametrar som möjliggör andra funktioner som:</br></br>* generic_data - aktiverar användningen av [TempPass för kampanjerbjudande](https://tve.helpdocsonline.com/promotional-temp-pass)</br></br>Exempel: `generic_data=("email":"email@domain.com")` |
