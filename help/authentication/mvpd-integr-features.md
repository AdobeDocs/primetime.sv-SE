...
## Översikt {#mvpd-int-features-overview}
...
## 1. Kärnfunktioner {#core-func-features}
...
| 1.17 | Auktoriseringsskyldigheter | MVPD ger ytterligare villkor i AuthZ-svaret, till exempel loggning, eller en uppdaterad OLCA (Maximum Parental Control Rating). | C |  |
...
| 3.2 | Återställning av lösenord | Med MVPD kan du återställa lösenord som är infogade i det federerade AuthN-flödet. | A |  |
...
Nu kan du importera kod från markeringstabellen direkt med hjälp av Arkiv/Klistra in tabelldata... -dialogrutan.
