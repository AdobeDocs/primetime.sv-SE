...
| `userID` | JSON-sträng | &quot;1o7241p&quot; | Användaridentifieraren. Om ett sidoskydd har stöd för underkonton och användaren inte är huvudkontot, `userID` kommer att vara annorlunda än `householdID`. |
...
| `typeID` | JSON-sträng | Primär | En flagga som identifierar om användarkontot är primärt/sekundärt konto |
...
| Namn | Detaljer | Kräver kryptering | Kommentarer |
| --- | --- | --- | --- |
...
|  | **Juridik **<br><br>**Avtal **<br><br>**Signerat (endast zip)** | **Användar-ID **<br><br>**på AuthN** | **Postnummer **<br><br>**på AuthN/Z** | **Klassificering **<br><br>**på AuthN/Z** | **Hushåll **<br><br>**ID på AuthN/Z** | **Kanal-ID på AuthN** | **Hushållschef på AuthN** | **Typ-ID på AuthN** | **Primär OID på AuthN** | Språk | Upstream UserID **på AuthN** | HBA-status | OnNet | inHome | Tillåt spegling i AuthZ | **Anteckningar** |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| **AT&amp;T** | **Ja** | **Ja** | **Ja (endast AuthN)** | **Nej** | **Ja (endast AuthN)** | **Nej** | **Nej** | **Ja** | **Ja** | **Nej** | **Ja** | **Nej** | **Nej** | **Nej** | **Nej** | Rättsligt avtal har undertecknats. |
| **Cablevision** | **Ja** | **Ja** | **Ja (endast AuthN)** | **Nej** | **Nej** | **Ja** | **Nej** | **Nej** | **Nej** | **Nej** | **Ja** | **Nej** | **Nej** | **Nej** | **Nej** | Rättsligt avtal har undertecknats. |
| **HTC** | **Nej** | **Ja** | **Nej** | **Nej** | **Nej** | **Ja** | **Nej** | **Nej** | **Nej** | **Nej** | **Ja** | **Nej** | **Nej** | **Nej** | **Nej** |  |
| **Proxy Massilon** | **Ja** | **Ja** | **Ja (endast AuthN)** | **Nej** | **Ja (endast AuthN)** | **Nej** | **Nej** | **Nej** | **Nej** | **Nej** | **Ja** | **Nej** | **Nej** | **Nej** | **Nej** | Rättsligt avtal har undertecknats. |
| **Rensning av proxy** | **Ja** | **Ja** | **Ja (endast AuthN)** | **Ja (endast AuthZ)** | **Nej** | **Nej** | **Nej** | **Nej** | **Nej** | **Ja** | **Ja** | **Nej** | **Nej** | **Nej** | **Nej** | Rättsligt avtal har undertecknats. |
