...
| message | *string* | Det går inte att kontakta din TV-leverantör |  | Läs ett läsbart meddelande som kan visas för slutanvändaren. |
...
1. som försöker åtgärda användarkontexten i programmet (programregistrering, autentisering, behörighet) 
...
|---|---|---|--------------|
| konfiguration | *authentication_deny_by_mvpd* | 403 | MVPD har returnerat ett beslut om att neka vid begäran om auktorisering för den angivna resursen. |
