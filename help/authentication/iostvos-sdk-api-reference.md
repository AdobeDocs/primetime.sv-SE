...
* Den senaste SDK:n för iOS AccessEnabler finns på [iOS Native Access Enabler Library](https://tve.zendesk.com/hc/en-us/articles/204963209-iOS-Native-AccessEnabler-Library).

>[!NOTE]
>
>Adobe rekommenderar att du endast använder Primetime-autentisering *public* API:er:
>
...
I slutet av AccessEnabler anropar du [`setAuthenticationStatus()`](#setAuthNStatus) återanrop med statuskoden 0, vilket anger att utloggningsflödet lyckades.
