...
Anta att `PTMediaPlayer` är en egenskap för klientspelaren, `self.player` i följande exempel representerar `PTMediaPlayer` -instans. I följande exempel implementeras `addObservers` som visas i installationsanvisningarna för PTMediaPlayer och som innehåller de flesta meddelanden:
...
<table frame="all" colsep="1" rowsep="1" id="table_ios_notifications"> 
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> En annan <span class="codeph"> PTMediaPlayerItem </span> i <span class="codeph"> PTMediaPlayer </span> har angetts. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> En ny <span class="codeph"> PTNotification </span> har lagts till i <span class="codeph"> PTNotificationHistoryItem </span> av aktuell <span class="codeph"> PTMediaPlayerItem </span>, det vill säga när en meddelandehändelse läggs till i meddelandehistoriken. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> <p>En prenumerationstagg identifieras i bakgrundsmanifestet och en ny <span class="codeph"> PTTimedMetadata </span> -instansen förbereds från den. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Hämta `PTAd` instans med `PTMediaPlayerAdKey`:
