...
* `PTNetworkConfiguration setURLTransformer:defaultTransformer` En set-metod som anges på `PTNetworkConfiguration` metadatainstansen för att ställa in `PTURLTransformer` implementeringen.
