...
Den här klassen kapslar in formatinformation för undertexter som teckensnittstyp, storlek, färg och bakgrundsopacitet. En associerad hjälpklass, `ClosedCaptionStylesBuilder`gör det lättare att arbeta med stilinställningar för undertexter.
...
1. Gör något av följande om du vill ändra formatinställningarna:
   ...
   * Använd `ClosedCaptionStylesBuilder` hjälpklass (används på `ClosedCaptionStyles` bakom kulisserna).
   * Använd `ClosedCaptionStyles` direkt.
...
<table frame="all" colsep="1" rowsep="1" id="table_87205DEFEE384AF4AF83952B15E18A42"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> <p>Bildtextens storlek. </p> <p> Kan endast anges till ett värde som definieras av <span class="codeph"> ClosedCaptionStyles.FONT_SIZE </span> array: 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> <p>Den effekt som används för teckensnittskanten, till exempel upphöjd eller ingen. </p> <p>Kan endast anges till ett värde som definieras av <span class="codeph"> ClosedCaptionStyles.FONT_EDGE </span> array. 
     <code class="syntax actionscript">
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> <p>Teckenfärgen. </p> <p>Kan endast anges till ett värde som definieras av <span class="codeph"> ClosedCaptionStyles.COLOR </span> array. 
     <code class="syntax actionscript">
