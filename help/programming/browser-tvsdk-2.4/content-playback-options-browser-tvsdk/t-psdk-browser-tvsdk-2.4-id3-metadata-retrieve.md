...
<table id="table_6C61886187FB44B4B9821E4B00200018"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>En typ av <span class="codeph"> TimedMetata </span> -objekt. </p> <p>För ID3-metadata är värdet <span class="codeph"> AdobePSDK.TimedMetadataType.ID3 </span>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>ID för <span class="codeph"> TimedMetata </span> -objekt. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> name </span> </p> </td> 
   <td colname="col2"> <p>Namn på <span class="codeph"> TimedMetata </span> -objekt. För ID3-metadata är värdet"ID3". </p> </td> 
  </tr> 
  <tr> 
