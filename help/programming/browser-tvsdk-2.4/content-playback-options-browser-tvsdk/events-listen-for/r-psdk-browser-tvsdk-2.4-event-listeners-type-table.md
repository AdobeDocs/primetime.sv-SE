...
När du registrerar händelseavlyssnare med Browser TVSDK anger du en händelsetyp att avlyssna och namnet på återanropet. När en händelse inträffar anropar webbläsaren TVSDK ditt återanrop och skickar ett händelseobjekt av lämplig typ till den.
  ...
  <tr rowsep="1"> 
   <td colname="2"> 
    <ul id="ul_kwy_cd4_2y"> 
     ...
     <li id="li_F7C9B933C6A44E80B57EB5274640A17B"><span class="codeph"> ÖVERORDNAD_UPDATED</span> </li> 
