...
<table id="table_3565328ABBEE4605A92EAE1ADE5D6F84"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Viktigt: Det här JSON-konfigurationsfilnamnet måste finnas kvar <span class="codeph"> ADBMobileConfig.json </span>. Det går inte att ändra namnet och sökvägen för den här konfigurationsfilen. Sökvägen till filen måste vara <span class="codeph"> &lt;source root=""&gt;/AdobeMobile </span>. </p> </td> 
  </tr> 
  <tr> 
