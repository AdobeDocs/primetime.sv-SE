...
Implementera callback-funktionen för meddelanden genom att hämta informationen `PTNotification` från `NSNotification` användarinformationen och läsa dess värden med hjälp av `PTMediaPlayerNotificationKey`:
