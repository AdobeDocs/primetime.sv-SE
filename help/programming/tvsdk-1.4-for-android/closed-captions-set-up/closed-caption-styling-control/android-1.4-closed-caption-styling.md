...
# Styr textningsformat {#control-closed-caption-styling-overview}
...
Den här klassen kapslar in formatinformation för undertexter som teckensnittstyp, storlek, färg och bakgrundsopacitet. En associerad hjälpklass, `TextFormatBuilder`gör det lättare att arbeta med stilinställningar för undertexter.
