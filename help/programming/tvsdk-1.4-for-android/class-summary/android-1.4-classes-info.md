...
<table frame="all" colsep="1" rowsep="1" id="table_BC74F0C72F7C443B92C9B28750D812A6"> 
 ...
 <tbody> 
  <tr rowsep="1"> 
   ...
   <td colname="2">En klass som utökar <span class="codeph"> Track</span> för att definiera ljudspårsavsnittet. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2">En klass som utökar <span class="codeph"> Track</span> för att definiera den stängda bildtextsabstraktionen. En klass som definierar <span class="codeph"> ClosedCaptions</span> -förkortningen. Ett spår med undertexter definieras unikt med namnet OCH tjänstetypen. Olika tjänstetyper kan ha samma namn.</td> 
  </tr> 
  <tr rowsep="1"> 
