---
description: TVSDK kräver specifika krav för medieinnehåll, manifestinnehåll, DRM och programvaruversioner.
title: Krav
...
TVSDK kräver specifika krav för medieinnehåll, manifestinnehåll, DRM och programvaruversioner.
...
Versionen av `#EXT-X-VERSION` i filen påverkar vilka funktioner som är tillgängliga för ditt program och vilka taggar som `EXT` är giltiga i [!DNL .m3u8] din spelningslista/manifest.
